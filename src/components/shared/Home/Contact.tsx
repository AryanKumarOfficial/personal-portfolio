    ...
    <section id="contact" className="relative py-32 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6">
        <motion.div
          ...
          whileInView="animate"
          viewport={{ once: true }}
          className="border rounded-2xl p-10 bg-muted/30 backdrop-blur text-center relative overflow-hidden"
        >
          {/* hover glow */}
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition bg-primary/10" />
          ...
          {/* description */}
          <motion.p variants={fadeUp} className="text-muted-foreground mt-4">
            {contact.description}
          </motion.p>
