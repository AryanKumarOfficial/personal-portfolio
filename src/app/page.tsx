    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100">
      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link href="https://github.com/AryanKumarOfficial" target="_blank" className="p-2 hover:bg-slate-100 rounded-full transition-colors">
              <Github className="w-5 h-5 text-slate-600" />
            </Link>
            <Link href="/api/auth/signin" className="px-4 py-2 bg-slate-900 text-white text-sm font-medium rounded hover:bg-slate-800 transition-colors">
              Admin Login
            </Link>
          </div>
        </div>
      ...
      <header className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="pt-8 flex justify-center gap-4">
            ...
            <Link href="mailto:aryanak9163@gmail.com" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-slate-700 border border-slate-200 rounded-lg font-medium hover:bg-slate-50 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
                ...
                <div key={i}>
                    ...
                    <div className="text-sm text-slate-500 font-medium uppercase tracking-wider mt-1">{stat.label}</div>
                </div>
            ))}
        </div>
      </section>
      ...
      <main id="projects" className="max-w-7xl mx-auto px-6 py-24">
        <div className="flex justify-between items-end mb-12">
            ...
            <Link href="https://github.com/AryanKumarOfficial" className="text-blue-600 font-medium hover:underline inline-flex items-center gap-1">
